...
import com.example.recipeapp.Listener.InstructionListener;
import com.example.recipeapp.Listener.RecipeClickListener;
import com.example.recipeapp.Listener.RecipeDetailsListener;
import com.example.recipeapp.Listener.SimilarRecipeListener;
...
public class RecipeDetailsActivity extends AppCompatActivity {
    ...
    private final RecipeDetailsListener recipeDetailsListener = new RecipeDetailsListener() {
        @Override
        public void deiFetch(RecipeDetailsResponse response, String message) {
            dialog.dismiss();
    ...
    private SimilarRecipeListener similarRecipeListener = new SimilarRecipeListener() {
        @Override
